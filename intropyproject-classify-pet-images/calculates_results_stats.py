...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # count the number of images that are dogs and are not dogs
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
        else:
            results_stats_dic['n_notdogs_img'] += 1

        # count how many times the classifier got the prediction right in counting dogs and not dogs
        if results_dic[key][3] == 1 and results_dic[key][4] == 1:
            results_stats_dic['n_correct_dogs'] += 1
        elif results_dic[key][3] == 0 and results_dic[key][4] == 0:
            results_stats_dic['n_correct_notdogs'] += 1

        # count how many times the classifier accurately predicted the breed of dog
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
            if results_dic[key][3] == 1:
                results_stats_dic['n_correct_breed'] += 1

    # caclulate the percentages with the results
